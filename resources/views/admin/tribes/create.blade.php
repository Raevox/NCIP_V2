...
<div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('admin.tribes.store') }}" id="tribeCreateForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="photo-preview-wrap" id="photoPreviewWrap">
                    ...
                    <button type="button" class="btn-remove-photo" onclick="removePhoto()" title="Remove photo">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit" id="submitTribeBtn">
