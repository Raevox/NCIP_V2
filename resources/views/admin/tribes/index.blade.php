...
.tribe-table tbody tr { transition: background 0.2s ease; }
.tribe-table tbody tr:hover { background: #f8fdf5; }
.tribe-table tbody tr:last-child td { border-bottom: none; }
...
.tribe-name-text { font-weight: 600; color: var(--text-dark); }
.tribe-desc-text { font-size: 12px; color: var(--text-soft); margin-top: 2px; }
...
<div class="tribes-content">
    ...
    <div class="page-header">
        <h2>
            <span class="header-icon"><i class="fas fa-flag"></i></span>
            Tribe Management
        </h2>
        <a href="{{ route('admin.tribes.create') }}" class="btn-add-tribe" id="addTribeBtn">
            <i class="fas fa-plus"></i> Add Tribe
        </a>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" style="font-family:'Poppins',sans-serif;">Delete Tribe</h5>
            ...
            <div class="modal-body text-center">
                ...
                <p style="font-size: 13.5px; color: var(--text-mid);">
                    You are about to permanently delete the tribe <strong id="deleteTribeName"></strong>.
...
function confirmDelete(id, name) {
    document.getElementById('deleteTribeName').textContent = name;
    document.getElementById('deleteForm').action = '/admin/tribes/' + id;
