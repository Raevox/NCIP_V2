...
<div>
    ...
    <div class="form-card">
        ...
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" id="newsEditForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    placeholder="Write a brief description or summary..."
                ...
                @if($news->image)
                    <div class="current-image-wrap">
                        ...
                        <div class="current-image-info">
                            <p>Current image</p>
                            <strong>Upload a new image below to replace it</strong>
                        </div>
                    </div>
                @endif
