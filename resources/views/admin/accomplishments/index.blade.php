...
<div class="acc-content">
    ...
    <div class="controls-bar">
        ...
        <div class="stats-pill">
            ...
            <strong id="accCount">{{ $accomplishments->total() }}</strong>
    ...
    <div id="tableContainer">
        @include('admin.accomplishments.partials.table')
    </div>
...
function fetchAccomplishmentsData(url = '{{ route("admin.accomplishments.index") }}') {
    ...
    .then(data => {
        ...
        document.getElementById('accCount').textContent = data.total;
    })
    .catch(() => {
        searchSpinner.style.display = 'none';
    });
...
function clearSearch() {
    searchInput.value = '';
    fetchAccomplishmentsData();
}

searchInput.addEventListener('input', function () {
    clearTimeout(searchTimer);
    searchTimer = setTimeout(() => fetchAccomplishmentsData(), 350);
});
...
document.getElementById('tableContainer').addEventListener('click', function (e) {
    ...
    if (link && link.href) {
        e.preventDefault();
        fetchAccomplishmentsData(link.href);
    }
});
</script>
