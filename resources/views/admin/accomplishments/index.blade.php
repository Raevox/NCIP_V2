...
@section('title', 'Accomplishment Management')
...
.acc-table tbody tr { transition: background 0.2s ease; }
.acc-table tbody tr:hover { background: #f8fdf5; }
.acc-table tbody tr:last-child td { border-bottom: none; }

/* Title cell */
.acc-title-cell { display: flex; align-items: center; gap: 10px; }
.acc-thumb {
...
.acc-title-text { font-weight: 600; color: var(--text-dark); font-size: 13px; }
.acc-date-text  { font-size: 11.5px; color: var(--text-soft); margin-top: 2px; }
...
<div class="acc-content">
    ...
    <div class="page-header">
        <h2>
            <span class="header-icon"><i class="fas fa-trophy"></i></span>
            Accomplishment Management
        </h2>
        <a href="{{ route('admin.accomplishments.create') }}" class="btn-add" id="addAccomplishmentBtn">
    ...
    <div class="controls-bar">
        <form method="GET" action="{{ route('admin.accomplishments.index') }}" class="search-wrapper" id="accSearchForm">
        ...
        <div class="stats-pill">
            ...
            <strong>{{ $accomplishments->total() }}</strong>
            <span>Accomplishment(s) found</span>
        </div>
    </div>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    <i class="fas fa-trophy"></i>
                                    <p>No accomplishments found{{ $search ? ' for "' . $search . '"' : '' }}.</p>
                                    @if($search)
                                        <a href="{{ route('admin.accomplishments.index') }}" style="color: var(--green-500); font-size: 13px;">
                                            Clear search
                                        </a>
                                    @endif
                                </div>
    ...
    @if($accomplishments->hasPages())
        <div class="pagination-row">
            ...
            <ul class="custom-pagination">
                ...
                @else
                    <li class="page-item"><a class="page-link" href="{{ $accomplishments->previousPageUrl() }}&search={{ $search }}"><i class="fas fa-chevron-left" style="font-size:11px;"></i></a></li>
                @endif
                ...
                @if($accomplishments->hasMorePages())
                    <li class="page-item"><a class="page-link" href="{{ $accomplishments->nextPageUrl() }}&search={{ $search }}"><i class="fas fa-chevron-right" style="font-size:11px;"></i></a></li>
                @else
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" style="font-family:'Poppins',sans-serif;">Delete Accomplishment</h5>
            ...
            <div class="modal-body text-center">
                ...
                <p style="font-size: 13.5px; color: var(--text-mid);">
                    You are about to permanently delete <strong id="deleteAccTitle"></strong>.
...
function confirmDelete(id, title) {
    document.getElementById('deleteAccTitle').textContent = title;
    document.getElementById('deleteForm').action = '/admin/accomplishments/' + id;
...
document.getElementById('searchInput').addEventListener('input', function () {
    ...
    searchTimer = setTimeout(() => {
        document.getElementById('accSearchForm').submit();
    }, 450);
});
</script>
