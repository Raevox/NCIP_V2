                        ...
                        <form id="step4Form" action="{{ route('applicant.coc.step4.store', ['id' => $step4['id'] ?? null]) }}" method="POST">
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="mother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="mother_origin" 
                                                   id="mother_origin"
                                                   class="form-control" 
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="maternal_grandfather_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="maternal_grandfather_origin" 
                                                   id="maternal_grandfather_origin"
                                                   class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="maternal_grandfather_ipgroup" 
                                                   id="maternal_grandfather_ipgroup"
                                                   class="form-control"
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="maternal_grandmother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="maternal_grandmother_origin" 
                                                   id="maternal_grandmother_origin"
                                                   class="form-control"
                                                   placeholder="Enter place of origin"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="maternal_grandmother_ipgroup" 
                                                   id="maternal_grandmother_ipgroup"
                                                   class="form-control"
                                                   placeholder="Enter IP group"
                                                   autocomplete="off"
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="great_grandfather_grandfather_mother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="great_grandfather_grandfather_mother_origin" 
                                                   id="great_grandfather_grandfather_mother_origin"
                                                   class="form-control"
                                                   placeholder="Enter place of origin"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandfather_grandfather_mother_origin', $step4['great_grandfather_grandfather_mother_origin'] ?? '') }}"required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="great_grandfather_grandfather_mother_ipgroup" 
                                                   id="great_grandfather_grandfather_mother_ipgroup"
                                                   class="form-control"
                                                   placeholder="Enter IP group"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandfather_grandfather_mother_ipgroup', $step4['great_grandfather_grandfather_mother_ipgroup'] ?? '') }}"required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="great_grandmother_grandfather_mother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="great_grandmother_grandfather_mother_origin" 
                                                   id="great_grandmother_grandfather_mother_origin"
                                                   class="form-control"
                                                   placeholder="Enter place of origin"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandmother_grandfather_mother_origin', $step4['great_grandmother_grandfather_mother_origin'] ?? '') }}"required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="great_grandmother_grandfather_mother_ipgroup" 
                                                   id="great_grandmother_grandfather_mother_ipgroup"
                                                   class="form-control"
                                                   placeholder="Enter IP group"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandmother_grandfather_mother_ipgroup', $step4['great_grandmother_grandfather_mother_ipgroup'] ?? '') }}"required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="great_grandfather_grandmother_mother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="great_grandfather_grandmother_mother_origin" 
                                                   id="great_grandfather_grandmother_mother_origin"
                                                   class="form-control"
                                                   placeholder="Enter place of origin"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandfather_grandmother_mother_origin', $step4['great_grandfather_grandmother_mother_origin'] ?? '') }}"required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="great_grandfather_grandmother_mother_ipgroup" 
                                                   id="great_grandfather_grandmother_mother_ipgroup"
                                                   class="form-control"
                                                   placeholder="Enter IP group"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandfather_grandmother_mother_ipgroup', $step4['great_grandfather_grandmother_mother_ipgroup'] ?? '') }}"required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section family-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="great_grandmother_grandmother_mother_origin">Place of Origin</label>
                                            <input type="text" 
                                                   name="great_grandmother_grandmother_mother_origin" 
                                                   id="great_grandmother_grandmother_mother_origin"
                                                   class="form-control"
                                                   placeholder="Enter place of origin"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandmother_grandmother_mother_origin', $step4['great_grandmother_grandmother_mother_origin'] ?? '') }}"required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   name="great_grandmother_grandmother_mother_ipgroup" 
                                                   id="great_grandmother_grandmother_mother_ipgroup"
                                                   class="form-control"
                                                   placeholder="Enter IP group"
                                                   autocomplete="off"
                                                   value="{{ old('great_grandmother_grandmother_mother_ipgroup', $step4['great_grandmother_grandmother_mother_ipgroup'] ?? '') }}"required>
                                        </div>
                                    </div>
                                </div>
                            </div>
